var sIntro = `
<p>
    Vous êtes un aventurier infatigable, vagabondant aux frontières du royaume,
    dans les provinces du Septentrion. La vie morne et paisible des villageois
    vous répugne et l'on vous a toujours vu courir sans repos les plaines et les
    bois, en quête de richesses et de périls. Malgré les longues errances et les
    rigueurs de la vie à la belle étoile, votre destinée &mdash; toujours imprévisible &mdash;
    vous satisfait pleinement. Vous n'avez peur de rien en ce bas monde car vous êtes
    un bretteur chevronné, toujours prompt à transpercer de votre fidèle épée quiconque,
    homme ou bête, se met en travers de votre route. Depuis dix jours que vous êtes entré
    dans les provinces du Nord, vous n'avez rencontré âme qui vive, ce qui d'ailleurs ne 
    vous chagrine nullement&nbsp;: votre seule compagnie, en effet, vous suffit amplement et
    vous n'êtes pas fâché de passer quelques journées au soleil à chasser, à manger et
    à dormir.
</p>
<p>
