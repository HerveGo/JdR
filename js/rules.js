sRules = `
<p>Vous avez en votre possession une épée, une armure de cuir, et une lanterne ainsi qu'un sac
contenant 10 rations (nourriture et boissons) pour le voyage. Afin de vous préparer à votre
quête, vous vous êtes entraîné au maniement de l'épée et vous vous êtes exercé avec
acharnement à accroître votre endurance.</p>
<ul>
    <li>Votre <span>FORCE</span> de départ est <span><b>$maForce</b></span>.</li>
    <li>Votre <span>ENDURANCE</span> est de <span><b>$maLife</b></span> (ce sont vos points de vie).</li>
    <li>Enfin, votre <span>CHANCE</span> est de <span><b>$maChance</b></span>.</li>
</ul>
<h3>Batailles</h3>
<p>
Il vous sera souvent demandé de combattre des créatures de toutes sortes. Parfois, vous aurez
la possibilité de choisir la fuite, sinon ou si vous décidez de toute façon de combattre,
il vous faudra mener la bataille dans un écran de combat spécifique.
Le combat se termine quand vous ou vos adversaires n'ont plus aucun points de vie.
</p>
<h3>Fuite</h3>
<p>
Parfois, vous aurez la possibilité de fuir un combat s'il vous semble devoir mal se terminer
pour vous. Si vous prenez la fuite, cependant, la créature vous aura automatiquement infligé
une blessure tandis que vous vous échappez. Vous ôterez alors deux points à votre 
<span>ENDURANCE</span>. C'est le prix de la couardise.
</p>
...
<ul>
<li>Si vous êtes chanceux, soit vous infligerez 2 points supplémentaires à votre adversaire si vous
parvenez à le blesser, soit vous ne subirez aucune blessure de son attaque.</li>
<li>Mais si vous êtes malchanceux, soit l'adversaire sera épargné d'un point de vie, soit son attaque sera plus
précise et vous perdrez 1 point de vie supplémentaire.</li>
</ul>
Rappelez-vous que vous perdrez un point de votre total de <span>CHANCE</span> à chaque fois que vous
Tentez votre Chance, et ce quel que soit le résultat.
</p>
<h3>Rétablir votre Force, Endurance ou Chance</h3>
<p><b>Force</b></p>
<p>
...
<p><b>Endurance et Provisions</b></p>
...
<p><b>Chance</b></p>
<p>
Vos points de <span>CHANCE</span> augmentent parfois au cours de l'aventure lorsque vous êtes
particulièrement chanceux. Rappelez-vous que, comme pour <span>l'ENDURANCE</span> et la <span>FORCE</span>,
vos points de <span>CHANCE</span> ne peuvent excéder leur niveau de départ.
Boire la Potion de Bonne Fortune rétablira à tout moment votre <span>CHANCE</span> à son niveau
initial et augmentera même d'un point votre chance de départ.
</p>
<h3>Équipements et potions</h3>
<p>
Au début de votre aventure, vous ne disposerez que d'un équipement minimum, mais vous pourrez
trouver d'autres accessoires au cours de vos voyages. Vous êtes armé d'une épée et vêtu d'une
armure de cuir. Vous portez sur vos épaules un sac à dos dans lequel vous rangerez vos provisions
...
Vous n'avez droit qu'à deux potions du même type, aussi, choisissez avec discernement&nbsp;!
</p>`;